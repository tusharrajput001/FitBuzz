  ...
  return (
    <div className="form3-container">
      ...
      <div className="form-field">
        ...
        <select name="diet_preference" value={formData.diet_preference} onChange={handleChange} required>
      ...
      <div className="form-field">
        ...
        <select name="workout" value={formData.workout} onChange={handleChange} required>
